...
x_train=np.array(new_sentences[len(new_sentences)//10:len(new_sentences)])
x_test=np.array(new_sentences[0:len(new_sentences)//10])
y_train=np.array(label[len(new_sentences)//10:len(new_sentences)])
y_test=np.array(label[0:len(new_sentences)//10])
