...
acc=0.0
for f in range(n_fold_num):
	b_sol,w_sol,mean,sigma,feature_enco=training.training(train_x,train_y,f,feature_num,n_fold_num,people_num,feature,norm)
	if(f==0):
		w_his1=w_sol
		b_his1=[b_sol]
	...
	if (n_fold_num!=1):
		acc_temp=training.validation(val_x,val_y,w_sol,b_sol,f,feature_num,feature,norm,mean,sigma,ratio)
		print(acc_temp)
		acc=acc+acc_temp


#print(acc/n_fold_num)
w_his1=w_his1.reshape(n_fold_num,feature_enco)
if (n_fold_num==1):
